function [var, A, U, B1, var1,corr1] = unfold_var_nxn(p, lambda,n)
% p should be between 0 and 1/n, lambda should be between 0 and 1
...
%f=@(lambda) unfold_var_nxn(0,lambda,n);
